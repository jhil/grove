  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="min-h-screen flex">
        ...
        <div className="flex-1 flex flex-col justify-center px-6 lg:px-12 xl:px-24 pt-20 pb-12">
          <div className="max-w-md">
            ...
            >
              Create your
              <br />
              <span className="text-sage-500">grove</span>
            </motion.h1>
        ...
        {/* Right Column - Visual */}
        <motion.div
          className="hidden lg:flex flex-1 bg-sage-50/50 items-center justify-center relative overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="absolute inset-0">
            <motion.div
              className="absolute top-1/4 left-1/4 w-64 h-64 bg-sage-200/30 rounded-full blur-3xl"
          ...
          <div className="relative z-10 text-center max-w-sm px-8">
            <motion.div
              ...
              transition={{ ...transition.enter, delay: 0.4 }}
            >
              <Leaf className="w-10 h-10 text-sage-500" />
            </motion.div>
            <motion.h2
            ...
            >
              After creating your grove, you&apos;ll get a link to share.
              Anyone with the link can view and help care for plants.
            </motion.p>
          </div>
        </motion.div>
      </main>
