...
import { Home, Flower2, TreeDeciduous, Flower } from "lucide-react";
	...
	return (
		<div className="min-h-screen bg-background overflow-hidden">
			...
			<div className="fixed inset-0 -z-10">
				<motion.div
					className="absolute top-32 left-1/4 w-72 h-72 bg-terracotta-100 rounded-full blur-3xl opacity-40"
					animate={{
						scale: [1, 1.2, 1],
						x: [0, 20, 0],
					}}
				...
				<div className="max-w-md mx-auto text-center">
					...
					>
						...
						>
							...
							{/* Wilted plant */}
							<motion.div
								className="absolute -top-8 left-1/2 -translate-x-1/2 text-terracotta-400"
								animate={{
									rotate: [0, 5, -5, 0],
								}}
								transition={{
							...
							>
								<Flower className="w-12 h-12 transform rotate-45" />
							</motion.div>
						</motion.div>
					...
					>
						<span className="text-8xl font-bold text-terracotta-200 font-display">
							404
						</span>
					</motion.div>
					...
					>
						While you&apos;re here, your plants might need water.
					</motion.p>
				</div>
			</main>
			...
			<motion.div
				className="fixed bottom-10 left-10 text-terracotta-200 opacity-20 pointer-events-none"
				animate={{
					y: [0, -10, 0],
					rotate: [0, 5, -5, 0],
				}}
