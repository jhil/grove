...
const photographers = [
  {
    ...
    unsplashUrl: "https://unsplash.com/photos/a-room-filled-with-lots-of-plants-and-furniture-hFKZ5-OT9Ys",
  ...
  },
  {
    ...
    unsplashUrl: "https://unsplash.com/photos/closeup-of-green-foliages-plants-in-a-garden-mWME2TYbs_s",
  ...
  },
  {
    ...
    unsplashUrl: "https://unsplash.com/photos/a-kitchen-counter-with-a-potted-plant-on-top-of-it-necy6c3gW88",
  ...
  },
  {
    ...
    unsplashUrl: "https://unsplash.com/photos/woman-reading-a-book-surrounded-by-lush-green-plants-v-2DNyyziGs",
  ...
  },
  {
    ...
    unsplashUrl: "https://unsplash.com/photos/a-kitchen-with-a-sink-and-shelves-filled-with-plants-mVnft46UU1Y-unsplash",
      ...
      <main className="px-6 lg:px-12 py-16 lg:py-24">
        <div className="max-w-4xl">
          ...
          <p className="text-lg text-muted-foreground mb-16 max-w-2xl">
            Plangrove is made with care. We&apos;re grateful to the photographers
            whose work brings our pages to life.
          </p>
          ...
          <section className="mb-20">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={tech.name} className="p-4 rounded-xl bg-sage-50/50">
          ...
          <section>
            ...
            <div className="p-6 rounded-xl bg-sage-50/50">
              <h3 className="font-medium text-foreground mb-2">System fonts</h3>
              <p className="text-muted-foreground">
                Plangrove uses your system&apos;s native font stack for optimal
                performance and a familiar reading experience across all devices.
              </p>
            </div>
          </section>
        </div>
